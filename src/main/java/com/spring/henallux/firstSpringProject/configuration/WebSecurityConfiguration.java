...
public class WebSecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    private static final String[] AUTHORIZED_REQUESTS_ANYBODY = new String[]{"/home", "/css/**", "/images/**", "/audio/**", "/html/**", "/inscription", "/inscription/send", "/catalog", "/articles", "/articles/**", "/cart"};
